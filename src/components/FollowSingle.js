                ...
                <div className="channel-container">
                    ...
                    >
                        <div className="channel-container-img">
                            <img src={`https://static-cdn.jtvnw.net/previews-ttv/live_user_${channel.user_name.toLowerCase()}-250x150.jpg`} alt="Channel screen"/>
                        </div>
                        ...
                        <div className="channel-container-info">
                            ...
                            <p className="stream-title"><strong>Title:</strong> 
                                {
                            ...
                            <p className="stream-time">
                                <strong>Started:</strong> {moment(channel.started_at).fromNow()}
                            </p>
